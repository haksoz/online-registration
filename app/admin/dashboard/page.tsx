      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 p-6 rounded-xl shadow-lg text-white">
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="px-2 py-1 text-xs font-semibold rounded-full bg-green-400 text-green-900">
              {stats.totalRevenueCount} kayıt
            </span>
          </div>
          ...
          <div className="mt-2 text-xs text-green-100 space-y-1">
            <p className="opacity-90">✅ Reddedilen iadeler dahil</p>
            <p className="opacity-90">⏳ Bekleyen iadeler hariç</p>
          </div>
        </div>

        <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 p-6 rounded-xl shadow-lg text-white">
          <div className="flex items-center justify-between mb-1">
            <p className="text-emerald-100 text-sm">Tahsil Edilen</p>
            <span className="px-2 py-1 text-xs font-semibold rounded-full bg-emerald-400 text-emerald-900">
              {stats.completedRevenueCount} kayıt
            </span>
          </div>
      ...
      {stats.refundAmount > 0 && (
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-700">Toplam İade Tutarı</span>
              <span className="text-2xl font-bold text-gray-900">
                {formatTurkishCurrency(stats.refundAmount)}
              </span>
            </div>
          </div>
        </div>
